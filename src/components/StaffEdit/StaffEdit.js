        ...
        <div className="col-12">
          <div className="card">
            <div className="card-header">
              <h4 className="card-title">Edit Staff Member</h4>
            </div>
                  ...
                  <div className="col-md-6 col-12">
                    <div className="mb-1">
                      ...
                      >
                        ...
                        <option selected={staff?.position === '1'} value={1}>One</option>
                        <option selected={staff?.position === '2'} value={2}>Two</option>
                        <option selected={staff?.position === '3'} value={3}>Three</option>
                      </select>
                      {errors.firstName && (
                        <div className="text-danger">
